...
const Cart = () => {
  return (
    <>
      <Navbar />
      <div className="bg-gray-200 w-full px-4 sm:px-10 lg:px-40 pt-10 pb-16 h-auto text-purple-700">
        ...
        <div className="mt-10 text-center lg:text-right">
          ...
          <button className="bg-purple-700 h-12 sm:h-14 mt-6 w-full sm:w-56 rounded-sm text-white hover:bg-purple-800">
            Go to checkout
          </button>
        </div>
      </div>
